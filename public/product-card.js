class ProductCard extends HTMLElement {
  connectedCallback() {
    ...
    this.innerHTML = `
      <article
        class="product-card"
        data-signals__ifmissing="{name${i}: '', description${i}: '', price${i}: 0, qty${i}: 1, inCart${i}: false, originalPrice${i}: 0, qtyInput${i}: null, visible${i}: false, countdown${i}: 300, confirming${i}: false}"
